...
do
	echo "curl -X POST -s --data-urlencode 'input@$file' https://javascript-minifier.com/raw > $file.min.js"
	curl -X POST -s --data-urlencode 'input@$file' https://javascript-minifier.com/raw > $(basename $file).min.js
done
